...
function ProductSection() {
  ...
  const products = [
    ...
    { id: 3, name: 'Lotto', description: 'Luxury big safa', price: 'Rp 7.000.000', image: '/product3.jpg' },
    { id: 4, name: 'Respirs', description: 'Outdoor bar table and stool', price: 'Rp 5.000.000', image: '/product4.jpg' },
    { id: 5, name: 'Grifo', description: 'Night lamp', price: 'Rp 1.500.000', image: '/product5.jpg' },
    { id: 6, name: 'Muggo', description: 'Small mug', price: 'Rp 1.500.000', image: '/product6.jpg' },
    { id: 7, name: 'Pingky', description: 'Cute bed set', price: 'Rp 7.000.000', image: '/product7.jpg' },
    { id: 8, name: 'Respirs', description: 'Outdoor bar table and stool', price: 'Rp 5.000.000', image: '/product4.jpg' },
    { id: 9, name: 'Grifo', description: 'Night lamp', price: 'Rp 1.500.000', image: '/product5.jpg' },
    { id: 10, name: 'Muggo', description: 'Small mug', price: 'Rp 1.500.000', image: '/product6.jpg' },
    { id: 11, name: 'Pingky', description: 'Cute bed set', price: 'Rp 7.000.000', image: '/product7.jpg' },
    { id: 12, name: 'Potty', description: 'Minimalist flower pot', price: 'Rp 5.000.000', image: '/product8.jpg' },
  ];
            ...
            >
              ...
              {hoveredIndex === product.id && (
                <div className="absolute inset-0 flex flex-col justify-center items-center gap-4 bg-gray-900 bg-opacity-40 rounded-lg transition-all">
                  <button className="bg-white text-yellow-500 font-bold py-2 px-4 mx-auto transition-colors hover:bg-yellow-500">
                    Add to Cart
                  </button>
