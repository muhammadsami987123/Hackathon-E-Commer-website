    ...
    <>
      ...
      <nav className="bg-white p-4">
        <div className="container mx-auto flex justify-between items-center">
          ...
          {isMenuOpen && (
            <ul className="flex flex-col text-xl items-center space-y-4 md:hidden">
              <li>
                <Link href="/" className="hover:text-blue-500">
                  Home
                </Link>
          ...
          <div className="flex items-center space-x-4">
            ...
            <HiOutlineShoppingCart className="text-2xl text-gray-600 hover:text-red-500 cursor-pointer" />
          </div>
        </div>
      </nav>
    </>
